...
export default class GoalB extends Phaser.Physics.Matter.Sprite {
    constructor(scene, x, y, texture, frame) {
        ...
        gfx.generateTexture('goalB', 10, 392);
        gfx.destroy();
        this.setTexture('goalB', 0);
        ...
        goalTest.fillRect(256, -256, 512, 512);
        goalTest.setMask(mask);

        this.displayHeight = 392;
        this.displayWidth = 10;

        let body = Bodies.rectangle(x, y, 10, 512, {});
